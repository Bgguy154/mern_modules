const questions = [
  ...
  {
    title: "pm of India",
    options: ["rahul", "narendra", "arvind", "mamta"],
    correctOption: 2,
  },
  {
    title: "cm of mah",
    options: ["eknath", "devendra", "ajay", "bacchu"],
    correctOption: 2,
  },
  {
    title: "president of India",
    options: ["draupadi", "radhakrishna", "shashi", "sonia"],
    correctOption: 1,
  },
  {
    title: "pm of US",
    options: ["Elon", "Bill", "Donald", "mark"],
    correctOption: 3,
  },
  {
    title: "topper of class",
    options: ["tanmay", "devanshu", "prajwal", "soyam"],
    correctOption: 2,
  },
];
